...
OutFile=ROOT.TFile("f_initial.root","r")
...
#    HistoData=OutFile.Get(dirName[0]+"dataset_5_"+histoname)
 ...
 #   ggWW=OutFile.Get(dirName[0]+"GluGluWWTo2L2Nu_"+histoname)
  ...
  #  VV.Add(ggWW)
    ...
    WZ.SetFillColor(ROOT.TColor.GetColor("#ffc866"))
    '''
...
#    WWW.SetFillColor(ROOT.TColor.GetColor("#99ccff"))
 ...
 #   stack.Add(ZTT)
    ...
    errorBand=OutFile.Get(dirName+"WZ_"+histoname).Clone()
    errorBand.Add(WZ)
    '''
    errorBand.Add(ZTT2)
    errorBand.Add(ZTT3)
...
c.SaveAs("plots/"+secondarg+"_"+firstarg+".png")
